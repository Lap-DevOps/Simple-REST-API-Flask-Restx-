...
class DevelopmentConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = (f"postgresql+psycopg2://{os.environ.get('DEV_DATABASE_USER')}:"
...
class ProductionConfig(Config):
    ENV = "production"
    DEBUG = False
    SQLALCHEMY_DATABASE_URI = (f"postgresql+psycopg2://{os.environ.get('PROD_DATABASE_USER')}:"
